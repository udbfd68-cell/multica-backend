...
export default function WorkspaceLayout({
  ...
  // Workspace routes require auth. If the auto-token is configured,
  // AuthInitializer will inject it automatically. No redirect to /login
  // — the loading indicator keeps showing until auth resolves.
  // If auth truly fails (no auto-token, no stored token), show NoAccessPage
  // instead of bouncing to a broken login page.
