...
import { AutopilotDetailPage as AutopilotDetail } from "@aurion/views/autopilots/components";
import { useWorkspaceId } from "@aurion/core/hooks";
import { autopilotDetailOptions } from "@aurion/core/autopilots/queries";
