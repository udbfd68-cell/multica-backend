...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.aurion.studio"
	cookieDomain string // cookie scope, e.g. ".aurion.studio"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.aurion.studio")
//   - COOKIE_DOMAIN           (e.g. ".aurion.studio")
