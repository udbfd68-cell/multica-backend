...
import type { Issue, IssueStatus, ProjectStatus, ProjectPriority } from "@aurion/core/types";
import { useAuthStore } from "@aurion/core/auth";
import { projectDetailOptions } from "@aurion/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@aurion/core/projects/mutations";
import { pinListOptions } from "@aurion/core/pins";
import { useCreatePin, useDeletePin } from "@aurion/core/pins";
import { issueListOptions, childIssueProgressOptions } from "@aurion/core/issues/queries";
import { useUpdateIssue } from "@aurion/core/issues/mutations";
...
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER, PROJECT_PRIORITY_CONFIG } from "@aurion/core/projects/config";
import { BOARD_STATUSES } from "@aurion/core/issues/config";
import { createIssueViewStore } from "@aurion/core/issues/stores/view-store";
import { ViewStoreProvider, useViewStore } from "@aurion/core/issues/stores/view-store-context";
...
import { EmojiPicker } from "@aurion/ui/components/common/emoji-picker";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const { defaultLayout, onLayoutChanged } = useDefaultLayout({
    id: "aurion_project_detail_layout",
  });
