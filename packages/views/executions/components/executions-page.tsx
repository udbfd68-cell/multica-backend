...
// â”€â”€ Execution Templates â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
interface ExecutionTemplate {
  ...
  /**
   * Execution mode:
   * - "browser" â†’ agent drives a real Chromium via Playwright MCP (default for any web task)
   * - "routine" â†’ headless / direct API calls only (for repetitive / background tasks)
   * - "hybrid"  â†’ prefers APIs, falls back to browser
   */
...
const TEMPLATES: ExecutionTemplate[] = [
  ...
  },
  {
    id: "custom",
    name: "Custom Agent",
    description: "Describe exactly what you want â€” the AI builds and executes it",
    icon: Settings2,
    category: "automation",
    defaultPrompt: "",
    tools: [],
...
// â”€â”€ Category Colors â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Stealth Anti-Detection Tools â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const STEALTH_TOOLS = [
  ...
  },
  {
    ...
    description: "CAPTCHA solving API â€” reCAPTCHA, hCaptcha, Turnstile",
  },
  {
    name: "capsolver",
    url: "https://github.com/capsolver/capsolver-python",
    description: "AI-powered CAPTCHA solving â€” faster and cheaper than 2captcha",
  },
  {
    name: "scrapfly",
...
// â”€â”€ Session Event Viewer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Active Session Panel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Main Executions Page â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export function ExecutionsPage() {
  ...
  const triggerMutation = useMutation({
    mutationFn: async ({
      ...
      const agent = await api.createManagedAgent({
        ...
        description: `Auto-created execution agent â€” ${template.description}`,
  ...
  // â”€â”€ If there's an active session, show it â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Main Builder UI â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
              ...
              <div className="rounded-md border p-2.5 space-y-2">
                ...
                <div className="grid grid-cols-3 gap-1">
                  {([
                    ...
                    { id: "routine", label: "Routine", hint: "Headless / direct APIs â€” fast & cheap" },
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      ...
                      {session.total_cost_usd
                        ? ` â€¢ $${session.total_cost_usd.toFixed(4)}`
                        : ""}
                    </p>
                  </div>
...
// â”€â”€ System Prompt Builder â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function buildSystemPrompt(
  ...
  parts.push("1. Execute the task completely and autonomously â€” do NOT ask for confirmation.");
  ...
  if (stealth) {
    parts.push("");
    parts.push("## Stealth Mode â€” CRITICAL");
    ...
    parts.push("- NEVER use headless browser mode â€” use headed or `--headless=new`");
