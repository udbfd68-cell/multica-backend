 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "aurion-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "aurion-static.copilothub.ai")
 */
